...
def send_email(serializer):
    send_mail('Intruder with weapon detected!', 
...
def prepare_alert_message(serializer):
    ...
    uuid = split(uuid_with_slashes, "/")

    url = 'http://127.0.0.1:8000/alert/' + uuid[1] 

    return 'Intruder with weapon detected! View alert at ' + url 
